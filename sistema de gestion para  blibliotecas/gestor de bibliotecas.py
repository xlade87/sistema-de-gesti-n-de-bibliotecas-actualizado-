...
def guardar_libro():
    ...
    except IndexError: # Por si acaso result no tiene el formato esperado
...
def guardar_autor():
    ...
    if success:
        # El SP devuelve un mensaje de éxito/error
...
# Botones de exportación para Usuarios
ttk.Button(frame_botones_user, text="Exportar a Excel", command=exportar_usuarios_excel).pack(side="left", padx=5)
ttk.Button(frame_botones_user, text="Exportar a PDF", command=exportar_usuarios_pdf).pack(side="left", padx=5)
...
# Botones de exportación para Préstamos
ttk.Button(frame_devolucion, text="Exportar a Excel", command=exportar_prestamos_excel).grid(row=0, column=3, padx=10)
ttk.Button(frame_devolucion, text="Exportar a PDF", command=exportar_prestamos_pdf).grid(row=0, column=4, padx=10)
...
# Botones de exportación para Autores
ttk.Button(frame_botones_autor, text="Exportar a Excel", command=exportar_autores_excel).pack(side="left", padx=5)
ttk.Button(frame_botones_autor, text="Exportar a PDF", command=exportar_autores_pdf).pack(side="left", padx=5)
